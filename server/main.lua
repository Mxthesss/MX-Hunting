...
RegisterNetEvent('mx-hunting:harvestCarcass')
AddEventHandler('mx-hunting:harvestCarcass',function (entityId, bone)
...
RegisterNetEvent('mx-hunting:SellCarcass')
AddEventHandler('mx-hunting:SellCarcass',function (item)
